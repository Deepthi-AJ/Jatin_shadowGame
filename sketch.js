...
destinyhealth.addAnimation("healthbar1",healthbrImage)
destinyhealth.addAnimation("healthbar2",healthbr2Image)
destinyhealth.addAnimation("healthbar3",healthbr3Image)
destinyhealth.addAnimation("healthbar4",healthbr4Image)
destinyhealth.addAnimation("healthbar5",healthbr5Image)
destinyhealth.addAnimation("healthbar6",healthbr6Image)
...
if(attack!==0){
  switch (attack){
    case 1:destinyhealth.changeAnimation("healthbar1",healthbrImage);
    thunderGroup.destroyEach();
      break;
      case 2:destinyhealth.changeAnimation("healthbar2",healthbr2Image);
      thunderGroup.destroyEach();
      break;
      case 3:destinyhealth.changeAnimation("healthbar3",healthbr3Image);
      thunderGroup.destroyEach();
      break;
      case 4:destinyhealth.changeAnimation("healthbar4",healthbr4Image);
      thunderGroup.destroyEach();
      break;
      case 5:destinyhealth.changeAnimation("healthbar5",healthbr5Image);
      thunderGroup.destroyEach();
      break;
case 6:destinyhealth.changeAnimation("healthbar6",healthbr6Image);
thunderGroup.destroyEach();
break;
default :thunderGroup.destroyEach();
bg.velocityX=0;
gameState = "end";
